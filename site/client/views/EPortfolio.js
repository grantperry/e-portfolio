...
export const P1 = () => {
	return (
		<p>
			...
			<p>
				I have written a driver for the ArduCam payload. This involved taking code written by a previous intern and determining how to make the payload work on the CubeSat Processor. To achieve this, I had to establish the systems that interface with the ArduCam and advise my colleagues to make changes to the hardware configurations. Edits to the Linux kernel were made to correctly configure the i2c and SPI busses (as these are how the ArduCam communicates with a processor). The software/driver written are functioning on the test hardware and is able to capture images to non-volitle storage.
			</p>
			<p>
				I am writing a driver for the main mission payload (A Short Wave InfraRed (SWIR) Camera). The majority of my time has been dedicated to this task, which has involved designing and implementing sub-systems that have different, but quite cruicial tasks in the big picture. The last week has resolved most of the work on the sub-systems into a working system. Streams of images are captured to non-volitile storage, but there is some refinement to be done to ensure this process happens smoothly.
			</p>
			<p>
				A lot of general use testing has come as part of developing the software/drivers I have worked on. The majority of testing will be done during the official testing period, after I have completed the internship.
			</p>
			<p>
				This experience has developmed my skills in writing C code, developing Linux Kernel Modules, working with hardware and hardware engineers. I have enjoyeed working in a team where information is freely exchanged and my input is valued and is used constructivly.
			</p>
			<p>
			...
			<p className="caption">
				<img src="https://www.researchgate.net/profile/Tom_Neubert2/publication/332210246/figure/fig7/AS:744014353530880@1554398253226/Block-diagram-of-the-AtmoCube-A1-payload-electronics-for-details-see-Neubert-et-al-20.png"
...
export const P2 = () => {
	return (
		<p>
			...
			I decided that to be able to aptly develop the software for my project, I would need a good global understanding of the Main Mission Module, paylaods and their interactions with one another.
			<p>
				I learn from my colleagues how their payloads operate in a strong team environment. There is lots of active discussion and physical demonstration of the various payloads by their respective developers. Intially my steep learning curve required a lot of 1 on 1 time with my collegues, but this has developed to more spontaneous discussion of design decisions as a team.
			</p>
			<p>
			...
			<p>
				An objective that arises from my general comprehension of the paylaod sub-systems and their interfaces is development of a process for reconfigring the Main Mission Module (MMM) FPGA during flight. The idea of this is that the CubeSat will likely need to be supplied with new hardware/software drivers while in flight! This is quite hard, as we have no physical connection to the MMM, which poses the risk of loosing control if the reconfiguration fails. As a result of this experinece my skills in documentation, trouble shooting and Electronic Systems have expanded both in depth and bredth.
			</p>
			<p>
				My experiences in gaining knowledge of payload systems and their interfaces has been novel, and I've developed a new appreciation for the role of adequite and accurate documentation in engineering. I believe this will improve my future performance as a Software or Electronics Engineer.
			</p>
		</p>
	);
};
		...
		<p>
			...
			<p style={{width: "min-content"}}>
				...
				<div className="caption">
					The Australian Telescope Compact Array (ATCA), Paul Wild Observatory, Narrabri, Central North NSW. This image shows five of the 6 22m radio telescopes arranged in a short baseline configuration on the East-West rail. The telescopes can be moved along a rail to change the "baseline" between them.
				</div>
			</p>
			<p>
				My internship at the CSIRO is sponsored by the Astronomy and Space Science (CASS) division. My project is a technolgoical extension of the science of astronomy. All interns of CASS participate in a week long field trip to the Paul Wild Observatory in Narrabri, Central North NSW. The purpose of the trip is to plan and execute astronomic experiments using the Australian Compact Telescope Array (ACTA).
			</p>
			<p>
				My team's project while useing the ACTA was preliminary experimental work developing a baseline of the ACTA's capabilites of tracking fast transiting radio sources in space. We gathered requirements from the egnineers (from the Australian Telescopes National Facility, ATNF), formulated a project plan, and found some possible candidates for observation. The project was to try to establish the limits of the ATCA tracking fast trainsiting radio sources, and if at all possible, extend them.
			</p>
			<p>
				We were allocated a 4 hour block of telescope time (an immense privledge). We refined the targets and wrote up a schedule file to be submitted to the ATCA control system. Our project was out of the scope of the available capabilites of the ATCA and required significant manual confiration and tuning while our observations occured.
			</p>
			<p>
				This project depended quite heavily on my knowledge of physics, telecomunications, electronics and orbital mechanics. I was in a team with engineers and astronomers and I found having my diverse knowledge of both electornic engineering and astronomy made it easy to communicate, understand data that was provided and collected, and solve logistical problems. It was nice to make a valuable contribution to the team's effort.
			</p>
			<p>
				My colleagues who work on my floor are part of the Signal Processing Techologies (SPT) group. They design the computation that turns the radio signals we receive on dishes to digital quantized data. In my work I have gained some understanding of SPT group's involvment in the ATNF and the world. I work with pioneers in radio telescope receivers and signal processors, who have manufactured key pices of infrustructure for international projects such as the <a href="https://en.wikipedia.org/wiki/Arecibo_Observatory">Arecibo Observatory</a>.
			</p>
			<p>
				This opportunity has strengthened my enthusiasm for learning more about radio astronomy and areonautical/space technolgy. I have particularly enjoyeed seeing my existing knowledge and experience placed in this context and I look forward to continuing in the industry.
			</p>
			<p>
